...
const works: Work[] = [
  ...
  },
  {
    ...
    category: "物流・荷待ち記録",
    description:
      "トラック運転手向けに、施設での荷待ち時間を位置情報で自動検知し、ほぼ操作なしで記録するアプリ。記録は荷主へ待機時間を示す根拠として使われるため、時刻を補正しても補正前の値と補正の事実が残る設計とし、走行中はUIをロックする。広告は記録画面に出さず、課金もStoreKit 2による買い切り一つのみ。記録機能は無料で無制限。",
